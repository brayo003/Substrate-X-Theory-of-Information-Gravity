#!/usr/bin/env python3
"""
ANALYZE WIKIPEDIA CLICKSTREAM - MEMORY SAFE
Uses chunking and proper sampling
"""
...
def load_and_sample_wikipedia_data(sample_size=100000):
    ...
    print("📊 Loading Wikipedia data with proper sampling...")
    
    COLUMN_NAMES = ['prev_title', 'curr_title', 'type', 'n']
...
# MAIN EXECUTION
print("🎯 WIKIPEDIA UTD ANALYSIS - MEMORY SAFE")
print("=" * 50)
