...
# Anchor 1: Resilient Ecosystem (Low E, High F, T=0.02)
# Anchor 2: Tipping Point (High E, Low F, T=0.88)
alpha, beta, gamma = solve_dcii_coefficients_two_anchor(
    e_s=0.20, f_s=0.80, t_s=0.02,
    e_c=0.90, f_c=0.15, t_c=0.88
)

print("--- Ecology DCII Calibration ---")
