...
# Anchor 1: Latent/Controlled (Low E, High F, T=0.01)
# Anchor 2: Active Pathogenic Outbreak (High E, Low F, T=0.60)
alpha, beta, gamma = solve_dcii_coefficients_two_anchor(
    e_s=0.10, f_s=0.90, t_s=0.01,
    e_c=0.85, f_c=0.15, t_c=0.60
)

print("--- Virology DCII Calibration ---")
